...
public class Scheduler_Service {
	...
	public String ExecuteInterestDemand() throws SQLException, ParseException {
		...
		List<TRAN_MAIN_TRM_WRK_ENTITY> values = tRAN_MAIN_TRM_WRK_REP.getResultindem();
	...
	public String ExecutefeeDemand() throws SQLException, ParseException {
		...
		List<TRAN_MAIN_TRM_WRK_ENTITY> values = tRAN_MAIN_TRM_WRK_REP.getResultfeedem();
	...
	//@Scheduled(cron = "0 42 16 * * ?")  // Runs every day at 3:20 PM IST
...
//	    }
	...
	//@Scheduled(cron = "0 55 9 * * ?", zone = "UTC")  // Runs every day at 3:20 PM IST
