...
public interface TRAN_MAIN_TRM_WRK_REP extends JpaRepository<TRAN_MAIN_TRM_WRK_ENTITY, String> {
    ...
    @Query(value = "SELECT TRAN_DATE_BAL FROM BGLS_DAILY_ACCT_BAL WHERE ACCT_NUM = :accountNum "
            ...
            "      )", nativeQuery = true)
    List<BigDecimal>findLatestTRAN_DATE_BALByAccountNumberBatchJob(@Param("accountNum") String accountNum, @Param("tranDate") String tranDate);
...
BigDecimal getTrandateBal(
 ...
 @Param("endDate") LocalDate endDate
    ...
    @Modifying
    @Transactional
    @Query(value = " UPDATE BGLS_DAILY_ACCT_BAL   " +
            " SET   " +
            "     GL_CODE        = :glCode,  " +
            "     GL_DESC        = :glDesc,  " +
            "     GLSH_CODE      = :glshCode,  " +
            ...
            "     TRAN_DR_BAL    = :totalDebit,  " +
            "     TRAN_CR_BAL    = :totalCredit,  " +
            "     TRAN_DATE_BAL  = :tranDateBal,  " +
            "     TRAN_TOT_NET   = :netAmount,  " +
            "     END_TRAN_DATE  = TO_DATE('2099-12-31', 'YYYY-MM-DD'),  " +
            "     ENTRY_USER_ID  = 'SYSTEM',  " +
            "     ENTRY_TIME     = SYSDATE,  " +
            "     DEL_FLG        = 'N',  " +
            "     OPENING_BAL    = :updatedOpenBal  " +
            " WHERE   " +
            "     ACCT_NUM  = :accountNum  " +
    ...
    List<Object[]> getNetDebitCreditWithCountForCurrentDateByAcctNum(@Param("from_date") String from_date,@Param("to_date") String to_date,@Param("acct_num") String acct_num);
